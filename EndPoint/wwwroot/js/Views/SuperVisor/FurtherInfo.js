...
(function (web, $) {
    ...
    function intiTab(TabId = null,CustomerId=null) {
    ...
    function initFurtherInfo(CustomerId=90) {
          
        intiTab(1, CustomerId);

       
    }

    function intiFormShow(Id = null, Columns = null, CustomerId = null) {

        intiForm(Id, CustomerId );
        intiFormAnswer(Id, Columns, CustomerId);
       
    }


    function intiForm(FormID = null, CustomerId = null) {

        AjaxCallAction("POST", "/api/superVisor/FurtherInfo/Get_DataFormQuestionss", JSON.stringify({ DataFormId: FormID, CustomerId: CustomerId, PageIndex: 0, PageSize: 0 }), true, function (res) {
    ...
    function intiFormQuestion(FormID = null, Name = null, CustomerId = null) {
    ...
    function intiFormSingelAnswer(FormID = null, CustomerId = null) {
        AjaxCallAction("POST", "/api/superVisor/FurtherInfo/Get_DataFromAnswerss", JSON.stringify({ FormId: FormID, CustomerId: CustomerId, PageIndex: 0, PageSize: 0 }), true, function (res) {
    ...
    function intiFormAnswer(FormID = null, ColumNum = null, CustomerId = null) {

        AjaxCallAction("POST", "/api/superVisor/FurtherInfo/Get_DataFormAnswerTabless", JSON.stringify({ FormId: FormID, CustomerId: CustomerId, PageIndex: 0, PageSize: 0 }), true, function (res) {
    ...
    function getFormAnswer(FormID = null, AnswerTableId = null, CustomerId=null) {

        AjaxCallAction("POST", "/api/superVisor/FurtherInfo/Get_DataFormAnswerTabless", JSON.stringify({ FormId: FormID, CustomerId: CustomerId, AnswerTableId: AnswerTableId, PageIndex: 0, PageSize: 0 }), true, function (res) {
