...
namespace ParsKyanCrm.Application.Services.Users.Commands.DeleteQuestionLevel
{
    ...
    public class DeleteQuestionLevelService : IDeleteQuestionLevelService
    {
        private readonly IDataBaseContext _context;
        private readonly IMapper _mapper;        
        private readonly IWebHostEnvironment _env;

        public DeleteQuestionLevelService(IDataBaseContext context, IMapper mapper, IWebHostEnvironment env)
        {
            _context = context;
            _mapper = mapper;            
            _env = env;
