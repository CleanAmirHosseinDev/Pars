...
namespace ParsKyanCrm.Application.Services.Users.Commands.DeleteCompanies
{
    ...
    public class DeleteCompaniesService : IDeleteCompaniesService
    {
        ...
        public DeleteCompaniesService(IDataBaseContext context, IMapper mapper, IBasicInfoFacad basicInfoFacad, IWebHostEnvironment env)
        {
            _context = context;
            _mapper = mapper;
        ...
        public ResultDto Execute(int id)
        {
            ...
            {                
                ...
                Ado_NetOperation.SqlUpdate(typeof(Domain.Entities.Companies).Name, new Dictionary<string, object>()
                    ...
                    }, string.Format("CompaniesID" + " = '{0}' ", id));
