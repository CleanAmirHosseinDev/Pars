...
(function (web, $) {
            ...
            if (res.isSuccess) {
                ...
                for (var i = 0; i < res.data.length; i++) {
                    ...
                    if (res.data[i].questionType == 'select') {
                        strFormId += "<select name='question" + res.data[i].dataFormQuestionId + "' id='question" + res.data[i].dataFormQuestionId + "' class='form-control select2' >" + combo(res.data[i].dataFormQuestionId) + "</select>";
    ...
    function combo(QuestionID = null) {
        ...
        AjaxCallAction("GET", "/api/customer/Corporate/Get_Options/" + QuestionID, true, function (res) {
