...
{((!string.IsNullOrEmpty(request.FromDateStr) && !string.IsNullOrEmpty(request.ToDateStr)) ? " where ll.LoginDate between " + request.FromDateStr1 + " and " + request.ToDateStr1 : string.Empty)}
");
