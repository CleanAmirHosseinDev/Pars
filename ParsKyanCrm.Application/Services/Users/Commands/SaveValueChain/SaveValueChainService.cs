    ...
    public class SaveValueChainService : ISaveValueChainService
    {
        ...
        public async Task<ResultDto<ValueChainDto>> Execute(ValueChainDto request)
        {
            ...
            try
            {
                ...
                {
                request.vc1 = con != null &&  !string.IsNullOrEmpty(item.vc1 ) ? item.vc1  : string.Empty;
                request.vc2 = con != null &&  !string.IsNullOrEmpty(item.vc2 ) ? item.vc2  : string.Empty;
                request.vc3 = con != null &&  !string.IsNullOrEmpty(item.vc3 ) ? item.vc3  : string.Empty;
                request.vc4 = con != null &&  !string.IsNullOrEmpty(item.vc4 ) ? item.vc4  : string.Empty;
                request.vc5 = con != null &&  !string.IsNullOrEmpty(item.vc5 ) ? item.vc5  : string.Empty;
                request.vc6 = con != null &&  !string.IsNullOrEmpty(item.vc6 ) ? item.vc6  : string.Empty;
                request.vc7 = con != null &&  !string.IsNullOrEmpty(item.vc7 ) ? item.vc7  : string.Empty;
                request.vc8 = con != null &&  !string.IsNullOrEmpty(item.vc8 ) ? item.vc8  : string.Empty;
                request.vc9 = con != null &&  !string.IsNullOrEmpty(item.vc9 ) ? item.vc9  : string.Empty;
                request.vc10 = con != null && !string.IsNullOrEmpty(item.vc10) ? item.vc10 : string.Empty;
                request.vc11 = con != null && !string.IsNullOrEmpty(item.vc11) ? item.vc11 : string.Empty;
                request.vc12 = con != null && !string.IsNullOrEmpty(item.vc12) ? item.vc12 : string.Empty;
                request.vc13 = con != null && !string.IsNullOrEmpty(item.vc13) ? item.vc13 : string.Empty;
                request.vc14 = con != null && !string.IsNullOrEmpty(item.vc14) ? item.vc14 : string.Empty;
                request.vc15 = con != null && !string.IsNullOrEmpty(item.vc15) ? item.vc15 : string.Empty;
                request.vc16 = con != null && !string.IsNullOrEmpty(item.vc16) ? item.vc16 : string.Empty;
                request.vc17 = con != null && !string.IsNullOrEmpty(item.vc17) ? item.vc17 : string.Empty;
                request.vc18 = con != null && !string.IsNullOrEmpty(item.vc18) ? item.vc18 : string.Empty;
                request.vc19 = con != null && !string.IsNullOrEmpty(item.vc19) ? item.vc19 : string.Empty;
                request.vc20 = con != null && !string.IsNullOrEmpty(item.vc20) ? item.vc20 : string.Empty;
                request.vc21 = con != null && !string.IsNullOrEmpty(item.vc21) ? item.vc21 : string.Empty;
                request.vc22 = con != null && !string.IsNullOrEmpty(item.vc22) ? item.vc22 : string.Empty;
                request.vc23 = con != null && !string.IsNullOrEmpty(item.vc23) ? item.vc23 : string.Empty;
                request.vc24 = con != null && !string.IsNullOrEmpty(item.vc24) ? item.vc24 : string.Empty;
                request.vc25 = con != null && !string.IsNullOrEmpty(item.vc25) ? item.vc25 : string.Empty;
