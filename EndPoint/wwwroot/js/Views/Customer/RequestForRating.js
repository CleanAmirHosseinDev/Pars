            ...
            if (res.isSuccess) {
                ...
                for (var i = 0; i < res.data.length; i++) {
                    ...
                    strM += "<tr><td>" + (i + 1) + "</td><td>"
                        ...
                        + "<a style='margin-right:5px' href='/Customer/RequestForRating/RequestReferences?id=" + res.data[i].requestId + "'"

                      //  + "<a style='margin-right:5px' title='مشاهده گردش کار' " + "onclick = 'Web.RequestForRating.Get_Detail(" + res.data[i].requestId + ");'"
                        + " class='btn btn-info fontForAllPage'> <img src='/css/GlobalAreas/dist/img/timeline-icon.png' style='width:20px' title=' مشاهده گردش کار' /></a>";
            ...
            if (res != null) {
                ...
                for (var i = 0; i < res.data.length; i++) {
                    ...
                    if (i == 0) {
                      ...
                      //  strTimeLine += "<p><strong>گیرنده ها :</strong></p>";
                       ...
                       // strTimeLine += "<span class='redColor'>[ خوانده نشده ]</span>";
                        ...
                        strTimeLine += "<span>گیرنده : </span>";
                        strTimeLine += "<span class='sender'>" + res.data[i].roleDesc + "</span>";
                        strTimeLine += "<br/>";
                    ...
                    if (i == 0) {
                        ...
                        strTimeLine += "<div class='customDiv'>رونوشت<hr/>";
