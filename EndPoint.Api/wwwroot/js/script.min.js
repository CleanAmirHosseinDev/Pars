        ...
        menuNotDuplicate.forEach(function (item, i) {
            ...
            for (var i = 0; i < menu.length; i++)
                if (item.group === menu[i].group && !GetNullEmpetyUndefined(menu[i].link))
                    srt += '<li><a onclick="setlstor("group_Item",' + menu[i].group_Item + ')" href="' + menu[i].link + '"><i class="feather icon-circle"></i><span id="' + menu[i].value + '" class="menu-item" data-i18n="List">' + menu[i].group_Item + '</span></a></li>';
